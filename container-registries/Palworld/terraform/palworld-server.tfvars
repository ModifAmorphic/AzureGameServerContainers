...
env_vars = {
  ...
  ENGINE_LanServerMaxTickRate =  "/script/onlinesubsystemutils.ipnetdriver/LanServerMaxTickRate=60"
  ENGINE_NetServerMaxTickRate =  "/script/onlinesubsystemutils.ipnetdriver/NetServerMaxTickRate=60"
  ...
  ENGINE_FixedFrameRate =  "/script/engine.engine/FixedFrameRate=60.000000"
  ENGINE_NetClientTicksPerSecond =  "/script/engine.engine/NetClientTicksPerSecond=60"
